...
def make_melon_types():
    ...
    cren = MelonType('cren','casaba','1996','green','False ','False')
    cren.add_pairing['proscuitto']
    all_melon_types.append(cren)

    yw = MelonType('ym','yellow_watermelon','2013','yellow','False','True')
    yw.add_pairing['ice_cream']
    all_melon_type.append(yw)
